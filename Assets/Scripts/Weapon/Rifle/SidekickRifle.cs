...
public class SidekickRifle: Rifle
{
    override protected void Start()
    {
        m_name = "Sidekick Rifle";
        base.Start();
    }
    ...
    {
        m_weaponAmmo--;
        Transform bulletFire = Instantiate(AssetManager.SidekickBulletFire(), bulletFirePosition, bulletFireRotation);
        Bullet bullet = Instantiate(AssetManager.SidekickBullet(), bulletPosition, bulletRotation);
